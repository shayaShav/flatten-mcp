...
Prefer to vet upgrades yourself? Pin an exact version: `npx -y flatten-mcp@2.0.3`.
...
**Verifying a build before you trust it.** Pin an exact version (`npx -y flatten-mcp@2.0.3`)
rather than `@latest`, inspect the published tarball (`npm view flatten-mcp@2.0.3 dist.tarball`,
