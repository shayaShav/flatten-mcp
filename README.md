...
Prefer to vet upgrades yourself? Pin an exact version: `npx -y flatten-mcp@2.0.4`.
...
**Verifying a build before you trust it.** Pin an exact version (`npx -y flatten-mcp@2.0.4`)
rather than `@latest`, inspect the published tarball (`npm view flatten-mcp@2.0.4 dist.tarball`,
